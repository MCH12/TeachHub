...
exports.xml = function(req, res) {
	...
	res.send('<?xml version="1.0" encoding="UTF-8"?><Response><Say voice="woman">This is a automated message for Alice from Teach Hub. Youve been offered a job at Southgate School on the 11th of August. Press one to accept and two to decline.</Say></Response>');
}
